...
const refresh_token_storage_service_1 = require("./services/refresh-token-storage.service");
...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([user_entity_1.User, organization_entity_1.Organization, refresh_token_entity_1.RefreshToken]),
        ...
        exports: [auth_service_1.AuthService, token_blacklist_service_1.TokenBlacklistService, token_service_1.TokenService],
    })
], AuthModule);
